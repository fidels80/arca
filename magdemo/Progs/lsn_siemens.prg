...
With toForm
	...
	*     la lunghezza disponibile in Arca
	* ---------------------------------------------------------------------------------
	...
	If Reccount('curEccedenze') > 0
		.PF.pgNormalizzazione.edtLog.WriteLog("Articoli esclusi per lunghezza codici superiore a quella disponibile in Arca:",,,,oApp.ColorGridForeRed)
		*.PF.pgNormalizzazione.edtLog.WriteLog("")
		Select curEccedenze
		Scan
